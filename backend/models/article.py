...
class Article(db.Model):
    ...
    tipo = db.Column(db.String(100))  # maquinaria grande, pequeña, electrica, herramienta
    ...
    status = db.Column(db.String(20), default='FUNCIONANDO')  # FUNCIONANDO, MANTENIMIENTO, REVISION, BAJA
