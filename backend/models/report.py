...
class Report(db.Model):
    ...
    report_type = db.Column(db.String(50), nullable=False)  # FALLA, MANTENIMIENTO, OBSERVACION, SOLICITUD
    message = db.Column(db.Text, nullable=False)  # descripción del problema
    status = db.Column(db.String(20), default='PENDIENTE')  # PENDIENTE, EN_REVISION, RESUELTO, CERRADO
